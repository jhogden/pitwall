...
export default function LoginPage() {
  ...
  return (
    <div className="max-w-md mx-auto mt-12">
      <h1 className="text-2xl font-bold text-pitwall-text text-center mb-8">Sign in to Pitwall</h1>
      ...
      <p className="mt-6 text-center text-sm text-pitwall-text-muted">
        ...
        <Link href="/register" className="text-pitwall-accent hover:underline">
          Create one
        </Link>
      </p>
    </div>
